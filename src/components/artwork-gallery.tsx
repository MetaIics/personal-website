...
const mini_gallery = [
  {
    ...
    caption: "Home",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2025/metalics-home.jpg",
  },
  {
    id: "2",
    ...
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2025/metalics-transition.gif",
  },
  {
    id: "3",
    alt: "Mala - Small ferret-like, draconic animal.",
    caption: "Mala, the Ferret-Dragon",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2024/mala.gif",
  },
  {
    id: "4",
    alt: "Logica - Key art for the song. The Human loses sight of the meaning of life.",
    caption: "Logica - Song Cover",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2023/human-logica.jpg",
  }
];
...
const images_2025 = [
  {
    ...
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2025/mialstec-comp.png",
  },
  {
    id: "2025_3",
    alt: "Riri (Doro) - Gift art for YuureiRiri's New Model and Birthday!",
    caption: "Riri (Doro)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2025/riri-doro.jpg",
  },
  {
    id: "2025_2",
    alt: "Dragon Profile Picture (Animated) - Test animation and design for the Dragon.",
    caption: "Dragon Profile Picture (Animated)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2025/dragon-profile-animated.gif",
  },
  {
    id: "2025_1",
    alt: "Home - The Human looks back, reminiscing a forgotten past.",
...
const images_2024 = [
  {
    ...
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2024/karwoo-tarot.jpg",
  },
  {
    id: "2024_1",
    alt: "Human (Keychain) - Side: Human for a keychain concept.",
    caption: "Human (Keychain)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2024/human-charm.png",
  },
  {
    id: "2024_2",
    alt: "Dragon (Keychain) - Side: Dragon for a keychain concept.",
    caption: "Dragon (Keychain)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2024/dragon-charm.png",
  },
  {
    id: "2024_3",
    alt: "Santa Cosplay (999) - Costume art for the 999 stream with fallinotes.",
    caption: "Santa Cosplay (999)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2024/human-santa.png",
  },
  {
    id: "2024_4",
  ...
  },
  {
    ...
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2024/metalics-revamp.jpg",
  },
  {
    id: "2024_6",
    alt: "Hua Sheng (DnD) - Silver Dragonborn Paladin. Always hungry for more.",
    caption: "Hua Sheng (DnD)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2024/dnd-hua.png",
  },
  {
    id: "2024_7",
...
const images_2023 = [
  {
    ...
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2023/metalics-transition-old.gif",
  },
  {
    id: "2023_01",
    alt: "Plushie (Dragon) - Plushie form of the dragon.",
    caption: "Plushie (Dragon)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2023/dragon-plush.png",
  },
  {
    id: "2023_1",
    alt: "Dragon (Sitting) - THe dragon is sitting.",
    caption: "Dragon (Sitting)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2023/dragon-sit.png",
  },
  {
    id: "2023_2",
    alt: "Happy 2023! - Celebration of all the friends I've made this year.",
    caption: "Happy 2023!",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2023/2023.jpg",
  },
  {
    id: "2023_3",
    alt: "Happy 2023! (Process) - Drawing process of the Dragon and Human.",
    caption: "Happy 2023! (Process)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2023/2023-process.gif",
  },
  {
    id: "2023_4",
    alt: "Logica - Key art for the song. The Human loses sight of the meaning of life.",
  ...
  },
  {
    ...
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2023/moth-cover.jpg",
  },
  {
    id: "2023_23",
    ...
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2023/mialstec-headshot.jpg",
  },
  {
    id: "2023_24",
    alt: "Moth - VTuber reveal art. Stuck in a void.",
    caption: "Moth (VTuber Model)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2023/moth-reveal.jpg",
  },
];
...
const images_2022 = [
  {
    ...
    caption: "Records",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/moth-record.gif",
  },
  {
    id: "2022_1",
    alt: "Emotes (Set 1) - Emotes for model reveal.",
    caption: "Emotes (Set 1)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/metalics-emotes.jpg",
  },
  {
    id: "2022_2",
    ...
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/peak.jpg",
  },
  {
    id: "2022_3",
    alt: "Plushies - Plushies of Nagi, Tappy, and Old Moth Model.",
    caption: "Plushies",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/moth-plushies.png",
  },
  {
    id: "2022_4",
    alt: "New Moth (Human) - Human Form Test.",
    caption: "New Moth (Human)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/moth-human.png",
  },
  {
    id: "2022_5",
    alt: "New Moth (Bust) - Updated Bust of the Moth.",
    caption: "New Moth (Bust)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/moth-bust.png",
  },
  {
    id: "2022_6",
    alt: "Moth (Bust) - Simple Bust of the Moth.",
    caption: "Moth (Bust)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/moth-old.jpg",
  },
  {
    id: "2022_7",
    alt: "Moth (Version 2) - Redesign of the Moth.",
    caption: "Moth (Version 2)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/moth-head.png",
  },
  {
    id: "2022_8",
    alt: "Notu (Model) - Full model for iamprobablynotu.",
    caption: "Notu (Model)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/notu.png",
  },
  {
    id: "2022_9",
    alt: "Cringe Nae Nae Baby - Draw over of a meme.",
    caption: "Cringe Nae Nae Baby",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/moth-cringe.jpg",
  },
  {
    id: "2022_10",
    alt: "Gremlin - Sketch of my VTuber and AL.",
    caption: "Gremlin",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/moth-gremlin.jpg",
  },
  {
    id: "2022_11",
    alt: "AL (Chilling) - Original Character. Chilling Animation",
    caption: "AL (Chilling)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/al-chilling.gif",
  },
  {
    id: "2022_12",
    alt: "AL (Cleaning) - Original Character. Cleaning Animation",
    caption: "AL (Cleaning)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/al-cleaning.gif",
  },
  {
    id: "2022_13",
    alt: "Moth (First Edition) - First ever model of my VTuber.",
    caption: "Moth (First Edition)",
    src: process.env.NEXT_PUBLIC_BASE_PATH + "/artworks/2022/moth-legacy.png",
  },
];
